...
| 🦅 | **독수리** | 급강하 한 방, 50:50 도박의 강탈자 | 급강하 폭격 (도박 스턴) |
...
**"하늘에서 콱! 50:50 도박의 순위 강탈자."** 트랙 위를 살짝 떠서 날아요.

- **스킬 — 급강하 폭격:** 바로 앞에 동물이 있으면 하늘로 솟았다 내리꽂아요. **50%는 상대를 스턴**시키지만, **50%는 자기가 처박혀요!** 하이 리스크 하이 리턴.
