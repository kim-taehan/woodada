...
const LINES: Record<string, string[]> = {
  ...
  'divebomb:activate': ['{n} 급강하 돌입! 도박 한 방 간다!', '{n} 하늘에서 내리꽂는다! 누구냐 표적은!', '{n} 슈웅— 발톱 펼치고 다이브!'],
  'divebomb:hit': ['{n} 명중! 앞주자 처박혔다 ㅋㅋ', '{n} 급강하 적중! 깃털 흩날린다!', '{n} 도박 성공! 표적 스턴 + 본인은 가속!'],
  'divebomb:self': ['어이쿠! {n} 자기가 처박혔다 ㅋㅋ', '{n} 도박 실패! 혼자 땅에 꽂혔다 ㅋㅋㅋ', '{n} 급강하하다 자폭! 별이 빙글빙글~'],
  'divebomb:dodge': ['{n} 헛챔! 고양이가 쏙 빠졌다 ㅋㅋ', '{n} 발톱 허공만 긁었다!'],
